...
```
    cd "CloudFormationCustomResourceDemo"
    dotnet restore
```

Execute unit tests
```
    cd "CloudFormationCustomResourceDemo/test/CloudFormationCustomResourceDemo.Tests"
    dotnet test
```

Deploy function to AWS Lambda
```
    cd "CloudFormationCustomResourceDemo/src/CloudFormationCustomResourceDemo"
